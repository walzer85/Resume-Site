          ...
          <Row>
            ...
            <img className="Header-image" src='https://media.licdn.com/dms/image/C4D03AQGFAEKgswK2uw/profile-displayphoto-shrink_200_200/0?e=1535587200&v=beta&t=_86dSGvHxKpTApFQ4eIp1ogSzoflOT7iBqpk_4oMZB0'/>
              <div className="App-title">
                <h1>Eric Walz</h1>
                <h3>Web Developer | Educator | Musician</h3>
              </div>
            </header>
            </Row>
            <Row className="Menu">
              <Col xs className="Menu-link">Biography</Col>
              <Col xs className="Menu-link">Education</Col>
              <Col xs className="Menu-link">Job Experience</Col>
              <Col xs className="Menu-link">Skills</Col>
